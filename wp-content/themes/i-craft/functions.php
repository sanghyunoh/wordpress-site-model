...
function icraft_scripts_styles() {
	...
	wp_enqueue_script( 'icraft-sidr', get_template_directory_uri() . '/js/jquery.dropdown.js', array( 'jquery' ), '2015-09-18', true );
	
	// Loads JavaScript file for small screen side menu.
	wp_enqueue_script( 'owl-carousel', get_template_directory_uri() . '/js/jquery.dropdown.min.js', array( 'jquery' ), '2014-01-13', true );		
	...
	wp_enqueue_style( 'side-menu', get_template_directory_uri() . '/css/dropdown.css', array(), '2015-09-18' );	
	...
	wp_enqueue_style( 'icraft-style', get_stylesheet_uri(), array(), '2015-08-18' );
