<div id="kboard-thumbnail-editor">
	<form method="post" action="<?php echo $url->getContentEditorExecute()?>" enctype="multipart/form-data" onsubmit="return kboard_editor_execute(this);">
		...
		<div class="kboard-attr-row">
			<label class="attr-name"><?php echo __('startdate', 'kboard')?></label>
			<div class="attr-value"><input type="date" name="startdate"></div>
		</div>
		<div class="kboard-attr-row">
			<label class="attr-name"><?php echo __('enddate', 'kboard')?></label>
			<div class="attr-value"><input type="date" name="enddate"></div>
		</div>
