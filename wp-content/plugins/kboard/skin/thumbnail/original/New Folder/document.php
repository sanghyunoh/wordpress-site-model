<div id="kboard-thumbnail-document">
	...
	<div class="kboard-document-wrap" itemscope itemtype="http://schema.org/Article">
		...
		<div class="kboard-detail">
			...
			<div class="detail-attr detail-startdate">
				<div class="detail-name"><?php echo __('startdate', 'kboard')?></div>
				<div class="detail-value"><?php echo date('Y-m-d')?></div>
			</div>
			<div class="detail-attr detail-enddate">
				<div class="detail-name"><?php echo __('enddate', 'kboard')?></div>
				<div class="detail-value"><?php echo date('Y-m-d')?></div>
			</div>
		</div>
