<div id="kboard-thumbnail-editor">
	<form method="post" class="kboard-gallery" action="<?php echo $url->getContentEditorExecute()?>" enctype="multipart/form-data" onsubmit="return kboard_editor_execute(this);">
		...
		<!--여기에 시작하는날짜, 끝나는날짜 입력칸  구현하여야 함-->
		<div class="kboard-attr-row">
			<label class="attr-name">시작일</label>
			<div class="attr-value"><input type="date" name="kboard_option_startdate" value="<?=$content->option->startdate?>"></div>
		</div>
		<div class="kboard-attr-row">
			<label class="attr-name">마감일</label>
			<div class="attr-value"><input type="date" name="kboard_option_enddate" value="<?=$content->option->enddate?>"></div>
		</div>		
		...
		<div class="kboard-attr-row">
			<label class="attr-name"><?php echo __('대표 이미지', 'kboard')?></label>
			<div class="attr-value">
